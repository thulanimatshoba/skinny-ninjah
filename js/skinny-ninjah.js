...
jQuery( document ).ready( function( $ ) {
	...
	const scrolltotop = {
		...
		scrollup() {
			...
			let t = isNaN( this.setting.scrollto ) ? this.setting.scrollto : parseInt( this.setting.scrollto );
		...
		init() {
			...
			jQuery( document ).ready( function( t ) {
				const o = scrolltotop,
					s = document.all;
				// eslint-disable-next-line no-mixed-operators,no-nested-ternary,no-unused-expressions
