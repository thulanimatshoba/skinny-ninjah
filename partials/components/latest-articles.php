...
<!--<h2 class="widget-title uk-text-center uk-padding-small uk-margin-large-bottom">-->
<?php //_e($blog_title ); 
?><!-- </h2>-->
...
<div uk-slider="autoplay: false; autoplay-interval: 9000">
	<div class="uk-position-relative uk-visible-toggle" tabindex="-1"
		uk-scrollspy="cls: uk-animation-scale-up; target: .blog-item; delay: 600; repeat: false">
					...
					foreach ( $posts as $post ) :
						...
						<li class="blog-item">
							<div class="article-story-header">
								...
								<div class="uk-meta">
									<span class="uk-float-left uk-margin-small-right">
										<?= get_the_date( 'd. M. Y' ); ?>
									</span>
									...
									<span class="post-comments"><i class="fa fa-comments">
