...
function skinny_ninjah_scripts() {
	wp_enqueue_style( 'skinny-ninjah-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'skinny-ninjah-style', 'rtl', 'replace' );

	wp_enqueue_script( 'skinny-ninjah-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
